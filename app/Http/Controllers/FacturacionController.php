...
class FacturacionController extends Controller
{
    ...
    public function guardarFactura($res,$xml)
    {
        try{
            ...
            $factura->iva_r = $res["iva_r_t"];
            $factura->isr_r= $res["isr_r_t"];
            ...
            foreach($conceptos as $concepto){
                ...
                $detfactura->precio = $concepto["precio"];
                $detfactura->importe = $concepto["importe"];
                ...
                $detfactura->subtotal = $concepto["subtotal"];
                $detfactura->iva_r = round((float)$concepto["iva_r"],2);
                $detfactura->isr_r = $concepto["isr_r"];
                $detfactura->total = $concepto["neto"];
