...
class Sello {
    ...
    public function generarXML($datos,$numcer)
    {
        ...
        if (($datos_emisor->rfc == "DAP100329TR6") || ($datos_emisor->rfc == "EMU100406QG4") || ($datos_emisor->rfc == "PME100111J68")){
            $versiontimbrado = "4.0";
        }else{
            $versiontimbrado = "3.3";
        }
		
		if(($datos_emisor->rfc == "SEM061220T56") || $datos_emisor->rfc == "CIN140605QM1"){
		 	$versiontimbrado = "4.0";
        }else{
            $versiontimbrado = "3.3";
        }
            ...
            if($concepto["iva"] != "0"){
                ...
                $xml = $xml . '<cfdi:Impuestos>';
                    $xml = $xml . '<cfdi:Traslados>';
                        ...
                        $sumaBase = $sumaBase + $concepto["neto"];
                        if ($concepto["ieps"] != "0") {
